      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-primary-100 rounded-full mb-6">
              <Headphones className="w-4 h-4 text-primary-600" />
              <span className="text-sm font-medium text-primary-700">Service Client</span>
            </div>
        ...
        <div className="container-custom mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            {supportCategories.map((cat, index) => (
              <div
                key={index}
                className="group p-6 rounded-2xl bg-white border border-gray-100 hover:border-primary-200 hover:shadow-xl transition-all duration-300 cursor-pointer hover:-translate-y-1"
              >
                <div
          ...
          <div className="mt-20 pt-20 border-t border-gray-200">
            ...
            {messagesLoading ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mt-4">Chargement des messages...</p>
              </div>
            ) : messagesError ? (
              ...
              <div className="grid gap-6 max-w-4xl mx-auto">
                {messages.map((msg) => (
                  <div
                    key={msg.id}
                    className="p-6 rounded-2xl bg-white border border-gray-200 hover:border-primary-300 hover:shadow-lg transition-all duration-300"
                  >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-3 mt-2 text-sm text-gray-600">
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            <a href={`mailto:${msg.email}`} className="text-primary-600 hover:underline">
                              {msg.email}
                            </a>
                          </span>
                        </div>
