...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative pt-24 pb-10">
      ...
      <div className="absolute bottom-20 -left-40 w-96 h-96 bg-accent-200/30 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto px-4">
        ...
        <div className="glass-card p-8 md:p-10 glow">
          ...
          <div className="text-center mb-8">
            <Link href="/" className="inline-flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-display font-bold text-gray-900">
                Credit<span className="text-primary-600">TN</span>
              </span>
            </Link>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/70 text-gray-500">ou par email</span>
            </div>
          </div>
                  ...
                  <div key={i} className="flex items-center gap-2">
                    <div
                      className={`w-4 h-4 rounded-full flex items-center justify-center ${
                        req.met ? 'bg-accent-500' : 'bg-gray-200'
                      } transition-colors`}
                    >
