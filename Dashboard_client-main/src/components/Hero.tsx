  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Decorative blobs */}
        <div className="absolute top-20 -left-40 w-96 h-96 bg-primary-200/30 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-20 -right-40 w-96 h-96 bg-accent-200/30 rounded-full blur-3xl animate-pulse-slow" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-lg">
              ...
              <strong className="text-gray-900">3, 6 ou 12 mensualités</strong> dans
            ...
            <div className="flex items-center gap-8 pt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">Approbation instantanée</span>
              </div>
              <div className="flex items-center gap-2">
                <TrendingUp className="w-5 h-5 text-primary-600" />
                <span className="text-sm text-gray-600">0% intérêt</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in">
            <div className="relative">
              {/* Phone Frame */}
              <div className="w-72 h-[580px] bg-dark-900 rounded-[3rem] p-3 shadow-2xl shadow-dark-900/30 animate-float">
                <div className="w-full h-full bg-gradient-to-br from-primary-500 via-primary-600 to-primary-800 rounded-[2.4rem] overflow-hidden relative">
                  {/* Notch */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-dark-900 rounded-b-2xl" />
              ...
              <div className="absolute -left-16 top-24 glass-card p-4 animate-slide-in-left shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Approuvé !</p>
              ...
              <div className="absolute -right-12 bottom-32 glass-card p-4 animate-slide-in-right shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900">+100 Boutiques</p>
