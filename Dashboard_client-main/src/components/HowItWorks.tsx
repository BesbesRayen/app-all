...
export default function HowItWorks() {
  return (
    <section className="section-padding bg-gray-50 relative overflow-hidden" id="how-it-works">
      ...
      <div className="container-custom mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full mb-6">
            <span className="text-sm font-medium text-gray-700">Comment ça marche</span>
          </div>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-14 left-[calc(50%+40px)] w-[calc(100%-40px)] h-[2px] bg-gradient-to-r from-gray-200 to-gray-100" />
              )}
              ...
              <div className="text-center space-y-4">
                ...
                <div className="relative inline-flex">
                  ...
                  <span className="absolute -top-2 -right-2 w-8 h-8 bg-white rounded-full flex items-center justify-center text-sm font-bold text-gray-900 shadow-md border border-gray-100">
                    {step.number}
                  </span>
                </div>
