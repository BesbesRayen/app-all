...
const styles = StyleSheet.create({
  ...
  backButton: { borderWidth: 1, borderColor: "#cbd5e1", borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6 },
  backText: { fontSize: 12, fontWeight: "700", color: "#334155" },
  title: { fontSize: 21, fontWeight: "800", color: "#111827", flex: 1 },
  card: { borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 14, backgroundColor: "#fff", padding: 12, gap: 8 },
  sectionTitle: { fontSize: 14, fontWeight: "800", color: "#0f172a", marginBottom: 2 },
  label: { fontSize: 12, fontWeight: "700", color: "#334155" },
  input: { borderWidth: 1, borderColor: "#cbd5e1", borderRadius: 10, paddingHorizontal: 12, paddingVertical: 11, backgroundColor: "#f8fafc" },
  primaryButton: { marginTop: 4, backgroundColor: "#0f766e", borderRadius: 10, alignItems: "center", paddingVertical: 11 },
